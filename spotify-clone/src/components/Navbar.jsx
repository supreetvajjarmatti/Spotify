  ...
  return (
    ...
    <div className='w-full flex justify-between items-center font-semibold'>
        <div className='flex items-center gap-2'>
            <img onClick={()=>navigate} className='w-8 bg-black p-2 rounded-2x1 cursor-pointer' src={assets.arrow_left} alt="" />
    ...
    <div className='flex items-center gap-2 mt-4'>
        ...
        <p className='bg-black text-white px-4 py-1 rounded-2xl cursor-pointer'>Poadcasts</p>
    </div>
